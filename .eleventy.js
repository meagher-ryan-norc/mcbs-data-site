module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addCollection("sortedFinancialAssistance", function (collectionApi) {
    return collectionApi.getFilteredByTag("financialAssistance").sort(function (a, b) {
